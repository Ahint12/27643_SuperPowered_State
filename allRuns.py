...
def Run1_Thread():
    if (True):
        ...
        WheelShutdown()
        FrontMotor.on_for_degrees(-35, 50, False)
        LWheel.on_for_degrees(15, 70, True)
...
def Trun3D():
    motorStall('D', -15, -10)
    BackMotor.on_for_degrees(5, 15, True)
...
def Run3_Thread():
    if (True):
        ...
        run3A.start()
        driveStraight(20, 140, True)
        oneWheelTurn('Right', 250, 2000, 208)
        WheelShutdown()
        driveStraight(20, 50, False)
        driveStraight(40, 50, False)
        ...
        # run3B.start()
        LWheel.on_for_degrees(15, 15, True)
        driveStraight(20, 50, True)
        ...
        run3C.start()
        oneWheelTurn('Right', 250, 2000, 355)
        ...
        WheelShutdown()
        twoWheelTurn('Right', 250, 2000, 205)
        WheelShutdown()
        driveStraight(20, 165, True)
        WheelShutdown()
        oneWheelTurn('Left', 250, 2000, 250)
        WheelShutdown()
        ...
        driveStraight(35, 140, True)
        oneWheelTurn('Right', 200, 2000, 235)
        WheelShutdown()
        # run3E = Thread(target=Trun3E)
        # run3E.start()        
        driveStraight(35, 250, True)
        oneWheelTurn('Right', 200, 2000, 300)
        driveStraight(20, 50, False)
        driveStraight(50, 250, False)
        move_steering.on_for_degrees(5, 80, 1700, True)
        WheelShutdown()
...
def Run4_Thread():
    if (True):
        ...
        BackMotorShutdown()
        sleep(0.2)
        BackMotor.on_for_degrees(-35, 60, True)
        BackMotorShutdown()
