...
def Run2_Thread():
    if (True):
        ...
        # LWheelShutdown()
        oneWheelTurn('Left', 250, 2000, 360)
        ...
        #####
        driveStraight(-25, 350, True)
        # driveStraight(-10, 90, True)
        sleep(0.4)
        driveStraight(20, 80, True)
        # LWheel.on_for_degrees(-20, 190, True)
        oneWheelTurn('Left', 250, 2000, -190)
        LWheelShutdown()
...
def Run3_Thread():
    if (True):
        ...
        oneWheelTurn('Right', 170, 3500, 255)
        WheelShutdown()
